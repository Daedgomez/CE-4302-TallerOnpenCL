...
int main(void) {
    ...
    global_item_size[0] = LIST_SIZE; // Process the entire lists
    global_item_size[1] = LIST_SIZE; // Process the entire lists
    local_item_size[0] = 4; // Divide work items into groups of 4
    local_item_size[1] = 4; // Divide work items into groups of 4
